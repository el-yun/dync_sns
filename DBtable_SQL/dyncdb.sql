...
CREATE TABLE `CODE` (
  ...
  `CODE_CONTENTS` TEXT,
  `REVISION` INT(50) NOT NULL UNIQUE,
  `USING` BOOLEAN,
  `REG_DATE` DATETIME,
  PRIMARY KEY (`CODE_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=UTF8;
...
INSERT INTO `USER` (`ISSUE_NAVERHASH`,`USER_NAME`,`USER_DESCRIPTION`,`CODE_REPOSITORY`) 
...
>>>>>>> 9529e6b536554ab0288d2ed9095ea55117ed7eeb
